...
* Yau-ShianWang, Hung-Yi Lee, and Yun-Nung Chen. 2019. [Tree Transformer: Integrating Tree Structures into Self-Attention](https://arxiv.org/pdf/1909.06639.pdf). In *Proceedings of EMNLP 2019*. ([Citation](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=2005&sciodt=0%2C5&cites=18227538214871902721&scipsc=&q=Tree+Transformer%3A+Integrating+Tree+Structures+into+Self-Attention&btnG=))
